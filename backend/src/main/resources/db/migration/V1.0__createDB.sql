...
alter table copies
    add constraint UK9ohbgfo1cb8l8805yxlsbvaqb unique (uzer, item);
alter table items
...
alter table copies
    add constraint FK8f4rstxmlxhbxm9qqkd431oi8 foreign key (uzer) references users;
