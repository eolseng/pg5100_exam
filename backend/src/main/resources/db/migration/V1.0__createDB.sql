...
create table copies (id bigint not null, created_at timestamp not null, item_id bigint not null, user_username varchar(255) not null, primary key (id));
...
alter table copies add constraint FKkr21203otxqi6jspe3cn6i7m8 foreign key (item_id) references placeholder_item;
alter table copies add constraint FKc7a0rbvhayy2wkb3avahurydo foreign key (user_username) references users;
